...
StyledRect {
    ...
    RowLayout {
        ...
        StyledRect {
            ...
            Layout.rightMargin: Config.appearance.spacing.large
        ...
        StyledRect {
            ...
            implicitWidth: cancelText.implicitWidth + Config.appearance.padding.medium * 2
            implicitHeight: cancelText.implicitHeight + Config.appearance.padding.medium * 2
