...
StyledRect {
    ...
    implicitWidth: inner.implicitWidth + Config.appearance.padding.medium * 2
            ...
            RowLayout {
                ...
                Repeater {
                    ...
                    RowLayout {
                        ...
                        Item {
                            implicitWidth: homeIcon.implicitWidth + (homeIcon.active ? Config.appearance.padding.extraSmall : 0) + folderName.implicitWidth + Config.appearance.padding.medium * 2
                            implicitHeight: folderName.implicitHeight + Config.appearance.padding.extraSmall * 2
                            ...
                            StyledText {
                                ...
                                anchors.verticalCenter: parent.verticalCenter
                                anchors.leftMargin: homeIcon.active ? Config.appearance.padding.extraSmall : 0
