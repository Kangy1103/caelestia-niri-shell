...
StyledRect {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            Layout.bottomMargin: -Config.appearance.padding.extraSmall / 2 - (root.expanded ? 0 : spacing)
            ...
            RowLayout {
                ...
                StyledRect {
                    implicitWidth: expandBtn.implicitWidth + Config.appearance.padding.small * 2
                    implicitHeight: groupCount.implicitHeight + Config.appearance.padding.extraSmall
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            Layout.leftMargin: Config.appearance.padding.extraSmall / 2
                            animate: true
                        ...
                        MaterialIcon {
                            Layout.rightMargin: -Config.appearance.padding.extraSmall / 2
                            animate: true
