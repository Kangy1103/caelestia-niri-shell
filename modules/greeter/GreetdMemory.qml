...
Singleton {
    ...
    readonly property string greetCfgDir: Quickshell.env("CNS_GREET_CFG_DIR") || "/var/cache/cns-greeter"
    ...
    readonly property bool rememberLastSession: GreetdEnv.readBoolOverride(Quickshell.env, ["CNS_GREET_REMEMBER_LAST_SESSION", "CNS_SAVE_SESSION"], true)
    readonly property bool rememberLastUser: GreetdEnv.readBoolOverride(Quickshell.env, ["CNS_GREET_REMEMBER_LAST_USER", "CNS_SAVE_USERNAME"], true)
