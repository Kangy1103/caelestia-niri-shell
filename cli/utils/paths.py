...
c_config_dir: Path = config_dir / "caelestia-niri-shell"
c_data_dir: Path = data_dir / "caelestia-niri-shell"
c_state_dir: Path = state_dir / "caelestia-niri-shell"
c_cache_dir: Path = cache_dir / "caelestia-niri-shell"
...
wallpapers_dir: Path = Path(os.getenv("CNS_WALLPAPERS_DIR", pictures_dir / "Wallpapers"))
...
screenshots_dir: Path = Path(os.getenv("CNS_SCREENSHOTS_DIR", pictures_dir / "Screenshots"))
screenshots_cache_dir: Path = c_cache_dir / "screenshots"

recordings_dir: Path = Path(os.getenv("CNS_RECORDINGS_DIR", videos_dir / "Recordings"))
