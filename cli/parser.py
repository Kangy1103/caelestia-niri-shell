...
from cns.subcommands import clipboard, emoji, scheme, screenshot, shell, wallpaper
from cns.utils.paths import wallpapers_dir
from cns.utils.scheme import get_scheme_names, scheme_variants
from cns.utils.wallpaper import get_wallpaper


def parse_args() -> tuple[argparse.ArgumentParser, argparse.Namespace]:
    parser = argparse.ArgumentParser(prog="cns", description="Main control script for CNS dotfiles")
